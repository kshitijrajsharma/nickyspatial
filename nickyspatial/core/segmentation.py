...
# Create a base class for parent inheritance
...
## TODO NAIVE IMPLEMENTATION OF WATERSHED SEGMENTATION
class WatershedSegmentation(BaseSegmentation):
    ...
    def _preprocess_image(self, image):
        ...
        -----------
        image : numpy.ndarray
            Input image (height, width) or (height, width, channels)

        Returns:
        --------
        numpy.ndarray
            Preprocessed image with edges enhanced
        """
    ...
    def _generate_seeds(self, image_shape, n_points):
        ...
        --------
        numpy.ndarray
            Seed array with labeled points
        """
...
class RegularGridSegmentation(BaseSegmentation):
    ...
    def _create_grid_segments(self, image_shape, grid_info):
        ...
        grid_info : dict
            Grid layout information from _calculate_grid_dimensions

        Returns:
        --------
        numpy.ndarray
            Segmentation array with segment IDs
        """
        height, width = image_shape
